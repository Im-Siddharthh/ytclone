        ...
        <div className="flex fixed top-0 justify-center items-center w-[100%] z-10 bg-white">
            <div className="flex w-[96%] py-3 justify-between items-center">
                ...
                <div className="flex items-center ">
                    ...
                    <a href="/"><img className="px-4" width={"115px"} src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/b8/YouTube_Logo_2017.svg/768px-YouTube_Logo_2017.svg.png" alt="yt_logo" /></a>
                </div>
                ...
                <div className="flex w-[10%] justify-between items-center">
                    ...
                    <Avatar src="https://im-siddharthh.github.io/Portfolio/assets/images/me03.png" size={35} round={true} />
                </div>
